...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Porta porta = new Porta(false, "azul", 0.8, 2.0, 0.03);
        ...
        // Criando as portas
        Porta porta1 = new Porta(false, "preta", 1.2, 2.0, 0.03);
        Porta porta2 = new Porta(true, "amarela", 1.0, 2.1, 0.04);
        Porta porta3 = new Porta(false, "verde", 0.9, 2.2, 0.05);
